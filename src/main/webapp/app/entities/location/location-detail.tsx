...
export const LocationDetail = (props: ILocationDetailProps) => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2>
          <Translate contentKey="lmPortal2App.location.detail.title">Location</Translate> [<b>{locationEntity.id}</b>]
        </h2>
        <dl className="jh-entity-details">
          <dt>
            <span id="conntry">
              <Translate contentKey="lmPortal2App.location.conntry">Conntry</Translate>
            </span>
          </dt>
          <dd>{locationEntity.conntry}</dd>
          <dt>
            <span id="city">
              <Translate contentKey="lmPortal2App.location.city">City</Translate>
            </span>
          </dt>
          <dd>{locationEntity.city}</dd>
          <dt>
            <span id="zipCode">
              <Translate contentKey="lmPortal2App.location.zipCode">Zip Code</Translate>
            </span>
          </dt>
          <dd>{locationEntity.zipCode}</dd>
          <dt>
            <span id="adress">
              <Translate contentKey="lmPortal2App.location.adress">Adress</Translate>
            </span>
          </dt>
          <dd>{locationEntity.adress}</dd>
        </dl>
